            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #A569BD; display:block;margin:auto;">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
